...
#Errores
Hubo un problema de ejecución al hacer los cambios a modo usuario. No se ejecutaba el proceso 2 porque estaba habilitado una instrucción WFI y esa instrucción necesitaba requerimientos especiales, quitarla resolvió el problema.
Luego hubo otro problema al modularizar aun más los archivos. Se creó el archivo rules.md para que el asistente ia nos ordenara los archivos pero cuando avanzamos con el proyecto llegamos al error de que al hacer pruebas con qemu se enciclaba (eso es adrede por el momento en el root.s). Esto debido que 
